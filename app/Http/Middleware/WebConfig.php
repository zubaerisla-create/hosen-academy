    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        config(
            [
                ...
                'filesystems.disks.s3.key' => $s3_keys?->AWS_ACCESS_KEY_ID ?? null,
                'filesystems.disks.s3.secret' => $s3_keys?->AWS_SECRET_ACCESS_KEY ?? null,
                'filesystems.disks.s3.region' => $s3_keys?->AWS_DEFAULT_REGION ?? null,
                'filesystems.disks.s3.bucket' => $s3_keys?->AWS_BUCKET ?? null,
            ]
        );
