                ...
                <div class="header-menu d-flex justify-content-end me-lg-auto ms-lg-0 ms-auto mt-2 pt-1">
                    <div class="nav-menu w-100">
                        <ul class="primary-menu main-menu-ul d-flex align-items-center w-100">
                            ...
                            <li ><a href="{{ route('ebooks') }}"
                                    class="@if ($current_route == 'ebooks' || $current_route == 'ebook.details') active @endif">{{ get_phrase('Ebooks') }}</a>
                            </li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('my.ebooks') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1"
                                                data-name="header-ebook-icon" viewBox="0 0 24 24" width="24"
                                                height="24">
                                                <path fill="#6B7385"
        ...
        <div class="off-menu">
            ...
            <div class="mt-3 flex-shrink-0">
                <ul class="list-unstyled ps-0">
                    ...
                    <li><a  class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3" href="{{ route('ebooks') }}"
                            class="@if ($current_route == 'ebooks' || $current_route == 'ebook.details') active @endif">{{ get_phrase('Ebooks') }}</a>
                    </li>
