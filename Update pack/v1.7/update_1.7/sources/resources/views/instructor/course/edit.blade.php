                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4 mt-3 mt-sm-0 d-flex justify-content-start justify-content-sm-end">
                            {{-- <button type="submit" class="btn ol-btn-outline-secondary @if (request('tab') == 'live-class' || request('tab') == 'curriculum') opacity-0 @endif">
                             ...
                             <button type="submit"
                                class="btn ol-btn-outline-secondary @if (request('tab') == 'live-class' || request('tab') == 'assignment' || request('tab') == 'curriculum') opacity-0 @endif">
                                {{ get_phrase('Save Changes') }}
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                        <div class="ol-sidebar-tab">
                            <div class="d-flex flex-column">
                                ...
                                <a class="nav-link @if ($tab == 'assignment') active @endif"
                                    href="{{ route('instructor.course.edit', [$param, 'tab' => 'assignment']) }}">
