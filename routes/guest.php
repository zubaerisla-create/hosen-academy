...
Route::controller(EbookController::class)->group(function () {
    Route::get('ebooks/{category?}', 'index')->name('ebooks');
    Route::get('ebook/{slug}', 'details')->name('ebook.details');
    Route::get('ebook/preview/{id}', 'preview')->name('ebook.preivew');
});
...
Route::controller(CommunityController::class)->group(function () {
    ...
    Route::post('post/like/{id}', 'toggle_like')->name('post.like');
    Route::post('post/save/{id}', 'toggle_save')->name('post.save');
    Route::get('saved-posts', 'saved_posts')->name('saved.posts');
    Route::get('remove-saved-post/{id}', 'remove_saved_post')->name('remove.saved.post');
    Route::get('my-posts', 'my_posts')->name('my.posts');
    Route::get('post/delete/{id}/{source?}', 'delete_post')->name('post.delete');
    Route::post('post/comment/{id}', 'store_comment')->name('post.comment');
    Route::get('popular-post/page/{id}', 'shared_post')->name('shared.post');
});

// Software Shop Page
use App\Http\Controllers\frontend\SoftwareShopController;
Route::get('software-shop', [SoftwareShopController::class, 'index'])->name('software.shop');
Route::get('software-shop/service/{slug}', [SoftwareShopController::class, 'service_details'])->name('software.service.details');
