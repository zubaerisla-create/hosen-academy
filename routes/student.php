...
use App\Http\Controllers\student\GamificationBadgesController;
...
Route::middleware(['auth'])->group(function () {
    ...
    //Gamification Badges
        Route::controller(GamificationBadgesController::class)->group(function () {
            Route::get('badges', 'index')->name('badges');
    });
    ...
    Route::controller(MyEbookController::class)->group(function () {
        ...
        Route::get('my-ebooks/{slug}/stream', 'stream_pdf')->name('my.ebooks.stream');
    });
