        ...
        <ul class="px-14px pb-24px">
            ...
            <li class="sidebar-first-li first-li-have-sub @if ($current_route == 'instructor.courses' || $current_route == 'instructor.course.create' || $current_route == 'instructor.course.edit' || $current_route == 'instructor.course.bundles' || $current_route == 'instructor.course.bundle.create' || $current_route == 'instructor.course.bundle.edit' || $current_route == 'instructor.course_bundle.instructor_revenue') active showMenu @endif">
                ...
                <ul class="first-sub-menu">
                    ...
                    <li class="sidebar-second-li second-li-have-sub @if ($current_route == 'instructor.course.bundles' || $current_route == 'instructor.course.bundle.create' || $current_route == 'instructor.course.bundle.edit' || $current_route == 'instructor.course_bundle.instructor_revenue') active @endif">
                        ...
                        <ul class="second-sub-menu">
                            ...
                            <li class="sidebar-third-li @if ($current_route == 'instructor.course_bundle.instructor_revenue') active @endif">
                                <a href="{{ route('instructor.course_bundle.instructor_revenue') }}">{{ get_phrase('Instructor Revenue') }}</a>
                            </li>
                        </ul>
                    </li>
                </ul>
