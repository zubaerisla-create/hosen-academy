                    ...
                    <div class="my-panel mt-5">
                        <div class="ol-card mb-30px">
                            <div class="col-sm-2 float-end col-md-2 p-0">
                                <a href="{{ route('my.course.bundles') }}" class="eBtn gradient float-md-end"><i class="fas fa-arrow-left"></i> {{ get_phrase('Back') }}
                                </a>
                            </div>
                                                ...
                                                <div class="max-w-280px w-100">
                                                    ...
                                                    <ul class="ol-list-group-2 w-100">
                                                        <li>
                                                            ...
                                                            <span class="title2 fs-16px">{{ currency($invoice->amount, 2) }}</span>
                                                        </li>
                                ...
                                <div class="invoice-table-wrap">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table ol-table mb-3 text-nowrap">
                                            <thead>
                                                <tr>
                                                    <th scope="col">{{ get_phrase('Course bundle') }}</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">{{ currency($invoice->amount, 2) }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <a href="#" onclick="printableDiv('my-invoice');" class="btn ol-btn-light-primary ol-btn-rounded print-d-none">{{ get_phrase('Print') }}</a>
                        </div>
                    </div>
                </div>
            </div>
