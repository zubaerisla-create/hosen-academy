...
@push('title', get_phrase('Course Bundle Admin Revenue'))
@push('meta')@endpush
@push('css')@endpush
@section('content')
        ...
        <div class="ol-card-body my-3 py-4 px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                <h4 class="title fs-16px">
                    ...
                    {{ get_phrase('Course Bundle Admin Revenue') }}
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="ol-card p-4">
        <div class="ol-card-body">
            <div class="row mb-3 mt-3 row-gap-3">
                    ...
                    @if ($reports->count() > 0)
                        <div class="custom-dropdown">
                            ...
                            <ul class="dropdown-list">
                                <li>
                                    <a class="dropdown-item" href="#" onclick="downloadPDF('.print-table', 'Course-bundle-admin-revenue')"><i class="fi-rr-file-pdf"></i> {{ get_phrase('PDF') }}</a>
                                </li>
                                <li>
                ...
                <div class="col-md-6">
                    <form class="form-inline" action="{{ route('admin.course_bundle.admin_revenue') }}" method="get">
