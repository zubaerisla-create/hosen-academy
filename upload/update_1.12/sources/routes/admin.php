...
Route::name('admin.')->prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::controller(NoticeBoardController::class)->group(function () {
        Route::get('course/edit/notice/{course_id}', 'notice')->name('course.notice');
        Route::get('course/edit/create_notice', 'create_notice')->name('course.notice_create');
        Route::post('course/edit/store_notice/{course_id}', 'store_notice')->name('course.notice_store');
        Route::get('course/edit/edit_notice/{id}',  'edit_notice')->name('course.edit_notice');
        Route::post('course/edit/update_notice/{id}', 'update_notice')->name('course.update_notice');
        Route::get('course/edit/notice_resend/{id}','resend_notice')->name('course.notice_resend');
        Route::get('course/edit/delete_notice/{id}', 'delete_notice')->name('course.notice_delete');
    });
    ...
    Route::controller(SettingController::class)->group(function () {
        ...
        Route::get('google_settings', 'google_settings')->name('google.settings');
        Route::post('google_settings/update', 'google_settings_update')->name('google.settings.update');

        // Gamification Badges Settings
        Route::get('gamification_settings', 'gamification_settings')->name('gamification.settings');
        Route::post('gamification_badges_store', 'gamification_badges_store')->name('gamification.badges.store');
        Route::get('gamification_badges_delete/{id}', 'gamification_badges_delete')->name('gamification.badge.delete');
        Route::get('gamification_badges_edit/{id}', 'gamification_badges_edit')->name('gamification.badge.edit');
        Route::post('gamification_badges_update/{id}', 'gamification_badges_update')->name('gamification.badge.update');
    });
    ...
    //Course Bundle
     Route::controller(CourseBundleController::class)->group(function () {
        ...
        Route::get('course-bundle/admin-revenue', 'adminRevenue')->name('course_bundle.admin_revenue');
        Route::get('course-bundle/instructor-revenue', 'instructorRevenue')->name('course_bundle.instructor_revenue');
