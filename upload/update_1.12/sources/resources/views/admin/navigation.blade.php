...
<div class="sidebar-nav-area">
    <nav class="sidebar-nav">
        <ul class="px-14px pb-24px">
            ...
            @if (has_permission('admin.courses'))
                ...
                $current_route == 'admin.course_bundle.admin_revenue' || 
                $current_route == 'admin.course_bundle.instructor_revenue' 

                ) active showMenu @endif">
                    ...
                    <ul class="first-sub-menu">
                        ...
                        @if (has_permission('admin.course.bundles'))
                            <li class="sidebar-second-li second-li-have-sub @if ($current_route == 'admin.course.bundles' || $current_route == 'admin.course.bundle.create' || $current_route == 'admin.course.bundle.edit' || $current_route == 'admin.course.bundle.subscription.report' || $current_route == 'admin.course_bundle.admin_revenue' || $current_route == 'admin.course_bundle.instructor_revenue') active @endif">
                                ...
                                <ul class="second-sub-menu">
                                    ...
                                    <li class="sidebar-third-li @if ($current_route == 'admin.course_bundle.admin_revenue') active @endif">
                                        <a href="{{ route('admin.course_bundle.admin_revenue') }}">{{ get_phrase('Admin Revenue') }}</a>
                                    </li>
                                    <li class="sidebar-third-li @if ($current_route == 'admin.course_bundle.instructor_revenue') active @endif">
                                        <a href="{{ route('admin.course_bundle.instructor_revenue') }}">{{ get_phrase('Instructor Revenue') }}</a>
                                    </li>
    ...
    @if (has_permission('admin.system.settings') ||
            ...
            has_permission('admin.gamification.settings') ||
            has_permission('admin.google.settings') ||
            ...
            <ul class="px-14px pb-24px mb-5 pb-5">
                <li
                    ...
                    <ul class="first-sub-menu">
                        ...
                        @endif
                        @if (has_permission('admin.gamification.settings'))
                            <li class="sidebar-second-li {{ $current_route == 'admin.gamification.settings' ? 'active' : '' }}">
                                <a href="{{ route('admin.gamification.settings') }}">{{ get_phrase('Gamification Badges') }}</a>
                            </li>
                        @endif
                        @if (has_permission('admin.google.settings'))
                            <li class="sidebar-second-li {{ $current_route == 'admin.google.settings' ? 'active' : '' }}">
                                <a href="{{ route('admin.google.settings') }}">{{ get_phrase('Google Login') }}</a>
                            </li>
                        @endif
