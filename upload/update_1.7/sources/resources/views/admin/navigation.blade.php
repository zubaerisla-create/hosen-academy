    ...
    <nav class="sidebar-nav">
        <ul class="px-14px pb-24px">
            ...
            @if (has_permission('admin.ebooks'))
                <li
                    class="sidebar-first-li first-li-have-sub @if (
                        $current_route == 'admin.ebooks' ||
                            $current_route == 'admin.ebook.edit' ||
                            $current_route == 'admin.ebook.create' ||
                            $current_route == 'admin.ebook.admin-revenue' ||
                            $current_route == 'admin.ebook.instructor-revenue' ||
                            $current_route == 'admin.ebook.categories') active showMenu @endif">
                    <a href="javascript:void(0);">
                    ...
                    <ul class="first-sub-menu">
                        ...
                        <li class="sidebar-second-li @if ($current_route == 'admin.ebook.instructor-revenue') active @endif">
                            <a
                                href="{{ route('admin.ebook.instructor-revenue') }}">{{ get_phrase('Instructor revenue') }}</a>
                        </li>
