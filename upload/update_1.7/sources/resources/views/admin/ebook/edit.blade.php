        ...
        <div class="col-lg-12">
            ...
            <div class="ol-card p-3">
                <div class="ol-card-body">
                    <form action="{{ route('admin.ebook.update', $ebook_details->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6 pb-2">
                                <div class="eForm-layouts">
                                    ...
                                    <div class="fpb-7 mb-3">
                                        <label class="form-label ol-form-label" for="edition">{{ get_phrase('Edition') }}
                                        </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fpb-7 mb-3">
                                    <label for="thumbnail"
                                        class="form-label ol-form-label">{{ get_phrase('Thumbnail') }}<span
                                            class="text-danger ms-1">*</span></label>
