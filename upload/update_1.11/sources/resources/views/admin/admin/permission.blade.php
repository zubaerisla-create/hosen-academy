...
@section('content')
    ...
    @php
        ...
        $routes = [
            ...
            'admin.customer.support.ticket.index' => get_phrase('Customer Support'),
            'admin.customer.support.ticket.create' => get_phrase('Create Ticket'),
            'admin.customer.support.ticket.edit' => get_phrase('Edit Ticket'),
            'admin.customer.support.ticket.message' => get_phrase('Ticket Message'),
            'admin.customer.support.ticket.faq.index' => get_phrase('Ticket Faq'),
            'admin.customer.support.ticket.report' => get_phrase('Ticket Report'),
            'admin.customer.support.ticket.macro.index' => get_phrase('Ticket Macros'),
            'admin.customer.support.ticket.category.index' => get_phrase('Ticket Categories'),
            'admin.customer.support.ticket.priority.index' => get_phrase('Ticket Priorities'),
            'admin.customer.support.ticket.status.index' => get_phrase('Ticket Status'),
        ];
