                        ...
                        <h2 class="accordion-header">
                            <div class="accor_wrap d-flex justify-content-between align-items-center">
                                ...
                                <ul class="d-flex gap-2">
                                    <li>
                                        <a href="javascript:;" onclick="ajaxModal('{{ route('admin.custom.section.edit', ['id' => $field->id]) }}','{{ get_phrase('Edit Section') }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Edit') }}">
                                            <i class="far fa-edit"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" onclick="confirmModal('{{ route('admin.custom.section.delete', ['id' => $field->id]) }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Delete') }}">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="card eCard bg-card position-relative">
                                                ...
                                                <div class="eControll d-flex gap-2 position-absolute top-0 end-0 p-2">
                                                    <a href="javascript:;" onclick="ajaxModal('{{ route('admin.custom.fields.edit', ['field_id' => $field->id, 'item_id' => $image->id]) }}','{{ get_phrase('Edit Field') }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Edit') }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <a href="javascript:;" onclick="confirmModal('{{ route('admin.custom.fields.delete', ['field_id' => $field->id, 'item_id' => $image->id]) }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Delete') }}">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        @foreach (json_decode($field->custom_field)->data as $slide)
                                            <div class="carousel-item {{ $first ? 'active' : '' }}">
                                                ...
                                                <div class="eControll d-flex gap-2">
                                                    <a href="javascript:;" onclick="ajaxModal('{{ route('admin.custom.fields.edit', ['field_id' => $field->id, 'item_id' => $slide->id]) }}','{{ get_phrase('Edit Field') }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Edit') }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                    <a href="javascript:;" onclick="confirmModal('{{ route('admin.custom.fields.delete', ['field_id' => $field->id, 'item_id' => $slide->id]) }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Delete') }}">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <ul class="list-group gap-3">
                                    @foreach (json_decode($field->custom_field)->data as $text)
                                        <li class="list-group-item eCard">
                                            <p>{!! $text->content !!}</p>
                                            <div class="eControll d-flex gap-2">
                                                <a href="javascript:;" onclick="ajaxModal('{{ route('admin.custom.fields.edit', ['field_id' => $field->id, 'item_id' => $text->id]) }}','{{ get_phrase('Edit Field') }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Edit') }}">
                                                    <i class="far fa-edit"></i>
                                                </a>
                                                <a href="javascript:;" onclick="confirmModal('{{ route('admin.custom.fields.delete', ['field_id' => $field->id, 'item_id' => $text->id]) }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Delete') }}">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                            </div>
                                        </li>
                                        ...
                                        @if ($embed_url)
                                            <div class="col-lg-12 mb-3">
                                                <div class="ratio ratio-16x9 eCard">
                                                    ...
                                                    <div class="eControll d-flex gap-2">
                                                        <a href="javascript:;" onclick="ajaxModal('{{ route('admin.custom.fields.edit', ['field_id' => $field->id, 'item_id' => $video->id]) }}','{{ get_phrase('Edit Field') }}')" data-bs-toggle="tooltip"
                                                            data-bs-title="{{ get_phrase('Edit') }}">
                                                            <i class="far fa-edit"></i>
                                                        </a>
                                                        <a href="javascript:;" onclick="confirmModal('{{ route('admin.custom.fields.delete', ['field_id' => $field->id, 'item_id' => $video->id]) }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Delete') }}">
                                                            <i class="fas fa-trash"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <ul class=" eCard">
                                                    <li class="singleFaq">
                                                        ...
                                                        <p> {{ $faq->answer }}</p>
                                                        <div class="eControll  d-flex gap-2">
                                                            <a href="javascripti:;" onclick="ajaxModal('{{ route('admin.custom.fields.edit', ['field_id' => $field->id, 'item_id' => $faq->id]) }}','{{ get_phrase('Edit Field') }}')" data-bs-toggle="tooltip"
                                                                data-bs-title="{{ get_phrase('Edit') }}"><i class="far fa-edit"></i></a>
                                                            <a href="javascript:;" onclick="confirmModal('{{ route('admin.custom.fields.delete', ['field_id' => $field->id, 'item_id' => $faq->id]) }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Delete') }}">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                        </div>
                                                    </li>
                                        ...
                                        @foreach (json_decode($field->custom_field)->data as $image)
                                            <div class="col-lg-3">
                                                <div class="card eCard mb-3 position-relative">
                                                    ...
                                                    <div class="eControll  d-flex gap-2 position-absolute top-0 end-0 p-2">
                                                        <a href="javascripti:;" onclick="ajaxModal('{{ route('admin.custom.fields.edit', ['field_id' => $field->id, 'item_id' => $image->id]) }}','{{ get_phrase('Edit Field') }}')" data-bs-toggle="tooltip"
                                                            data-bs-title="{{ get_phrase('Edit') }}"><i class="far fa-edit"></i></a>
                                                        <a href="javascript:;" onclick="confirmModal('{{ route('admin.custom.fields.delete', ['field_id' => $field->id, 'item_id' => $image->id]) }}')" data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Delete') }}">
                                                            <i class="fas fa-trash"></i>
                                                        </a>
