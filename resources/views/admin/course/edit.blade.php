                    ...
                    <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                        <div class="ol-sidebar-tab">
                            <div class="d-flex flex-column">
                                ...
                                <a class="nav-link @if ($tab == 'course-progress') active @endif" href="{{ route('admin.course.edit', [$param, 'tab' => 'course-progress']) }}">
                                ...
                                <a class="nav-link @if ($tab == 'custom-field') active @endif" href="{{ route('admin.course.edit', [$param, 'tab' => 'custom-field']) }}">
                                 ...
                                 <a class="nav-link @if ($tab == 'notice_board') active @endif" href="{{ route('admin.course.edit', [$param, 'tab' => 'notice_board']) }}">
                        ...
                        <div class="tab-content w-100">
                            ...
                            @includeWhen($tab == 'course-progress', 'admin.course.academic_progress')
                            ...
                            @includeWhen($tab == 'notice_board', 'admin.course.notice.notice_board')
                        </div>
                    </div>
                </div>
            </div>
