                ...
                <div class="header-menu d-flex justify-content-end me-lg-auto ms-lg-0 ms-auto mt-2 pt-1">
                    <div class="nav-menu w-100">
                        <ul class="primary-menu main-menu-ul d-flex align-items-center w-100 drop-area">
                            ...
                            {{-- <li class="have-mega-menu"><a class="menu-parent-a @if ($current_route == 'home') active @endif" href="{{ route('home') }}">{{ get_phrase('Home') }}
                             ...
                             --}}
                            <li class="have-mega-menu"><a class="menu-parent-a @if ($current_route == 'courses') active @endif" href="{{ route('courses') }}">{{ get_phrase('Courses') }} <i class="fa-solid fa-chevron-down nav-arrow"></i></a>
                                <ul class="mega-dropdown-menu mega main-mega-menu">
                                    <div class="mega-menu-items">
                                        <ul class="mega_list">
                            ...
                            <li><a href="{{ route('ebooks') }}" class="@if ($current_route == 'ebooks' || $current_route == 'ebook.details') active @endif">{{ get_phrase('Ebooks') }}</a></li>
                            <li class="have-mega-menu"><a class="menu-parent-a @if (in_array($current_route, ['tutor_list', 'course.bundles'])) active @endif" href="javascript:;">{{ get_phrase('More') }} <i class="fa-solid fa-chevron-down nav-arrow"></i></a>
                                <ul class="mega-dropdown-menu mega main-mega-menu">
                                    <div class="mega-menu-items">
                                        <ul class="mega_list">
                                            <li>
                                                <a href="{{ route('tutor_list') }}">
                                                    <span class="light-iconbox me-3">
                                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M10.009 10.5C12.2182 10.5 14.009 8.70914 14.009 6.5C14.009 4.29086 12.2182 2.5 10.009 2.5C7.79989 2.5 6.00903 4.29086 6.00903 6.5C6.00903 8.70914 7.79989 10.5 10.009 10.5Z" fill="#943DFF"></path>
                                                        <path opacity="0.4" d="M11.75 17.33C11.75 18.73 12.26 20.01 13.12 20.99C13.178 21.049 13.21 21.12 13.21 21.2C13.21 21.37 13.08 21.5 12.91 21.5H6C3.71 21.5 2.5 20.3 2.5 18.02C2.5 15.47 3.94 12.5 8 12.5H12C12.534 12.5 13.0249 12.5519 13.4709 12.6479C13.6769 12.6929 13.704 12.85 13.708 12.861C13.716 12.88 13.758 13.03 13.619 13.165C12.52 14.242 11.75 15.673 11.75 17.33Z" fill="#998EFF"></path>
                                                        <path d="M22.53 21.47L20.699 19.639C21.15 18.983 21.417 18.19 21.417 17.334C21.417 15.083 19.585 13.251 17.333 13.251C15.082 13.251 13.25 15.083 13.25 17.334C13.25 19.585 15.082 21.417 17.333 21.417C18.188 21.417 18.9809 21.15 19.6379 20.699L21.469 22.531C21.615 22.677 21.807 22.751 21.999 22.751C22.191 22.751 22.3831 22.678 22.5291 22.531C22.8231 22.237 22.823 21.763 22.53 21.47ZM14.75 17.333C14.75 15.909 15.909 14.75 17.333 14.75C18.758 14.75 19.917 15.909 19.917 17.333C19.917 18.757 18.758 19.916 17.333 19.916C15.909 19.917 14.75 18.758 14.75 17.333Z" fill="#943DFF"></path>
                                                        </svg>
                                                    </span>
                                                    <span class="me-auto">{{ get_phrase('Find A Tutor') }}</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('course.bundles') }}">
                                                   <span class="light-iconbox me-3">
                                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.4" d="M11.5 21H9.5C8.5 21 8 20.5 8 19.5V4.5C8 3.5 8.5 3 9.5 3H11.5C12.5 3 13 3.5 13 4.5V19.5C13 20.5 12.5 21 11.5 21Z" fill="#998EFF"></path>
                                                            <path opacity="0.4" d="M5.5 21H3.5C2.5 21 2 20.5 2 19.5V4.5C2 3.5 2.5 3 3.5 3H5.5C6.5 3 7 3.5 7 4.5V19.5C7 20.5 6.5 21 5.5 21Z" fill="#998EFF"></path>
                                                            <path opacity="0.4" d="M20.7972 20.533L18.855 20.9461C17.884 21.1521 17.2951 20.77 17.0891 19.799L13.993 5.23307C13.786 4.26207 14.1689 3.67308 15.1399 3.46708L17.0821 3.05399C18.0531 2.84799 18.6419 3.23009 18.8479 4.20109L21.9441 18.767C22.1501 19.738 21.7682 20.327 20.7972 20.533Z" fill="#998EFF"></path>
                                                            <path d="M13 7.75H8V6.25H13V7.75ZM13 16.25H8V17.75H13V16.25ZM7 6.25H2V7.75H7V6.25ZM7 16.25H2V17.75H7V16.25ZM19.21 5.89001L14.3501 6.93005L14.6599 8.40002L19.52 7.35999L19.21 5.89001ZM21.28 15.6L16.4199 16.64L16.73 18.11L21.5901 17.0699L21.28 15.6Z" fill="#943DFF"></path>
                                                        </svg>
                                                    </span>
                                                    <span class="me-auto">{{ get_phrase('Course Bundle') }}</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <li><a href="{{ route('software.shop') }}" class="@if ($current_route == 'software.shop') active @endif"><i class="fa-solid fa-store me-1 text-primary"></i>{{ get_phrase('Software Shop') }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-sm-5 col-md-3 col-xl-3 ms-auto col-auto">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('support.ticket.index') }}">
                                            <svg width="21" height="21" viewbox="0 0 24 24" fill="#6B7385" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4.6424 19.649C2.6924 19.649 1.0424 17.999 1.0424 16.049V10.9157C1.00073 8.48231 1.90073 6.19064 3.58407 4.47398C5.2674 2.76564 7.52573 1.81564 9.95907 1.81564C14.9257 1.81564 18.9591 5.85731 18.9591 10.8157V15.949C18.9591 17.9323 17.3424 19.549 15.3591 19.549C13.4091 19.549 11.7591 17.899 11.7591 15.949V13.6073C11.7591 12.399 12.7091 11.449 13.9174 11.449C15.1257 11.449 18.9591 12.399 18.9591 13.6073V16.1323C18.9591 16.474 18.6757 16.7573 18.3341 16.7573C17.9924 16.7573 17.7091 16.474 17.7091 16.1323V13.6073C17.7091 13.0407 14.3674 12.699 13.9174 12.699C13.3507 12.699 13.0091 13.1573 13.0091 13.6073V15.949C13.0091 17.224 14.0841 18.299 15.3591 18.299C16.6341 18.299 17.7091 17.224 17.7091 15.949V10.8157C17.7091 6.54064 14.2341 3.06564 9.95907 3.06564C7.8674 3.06564 5.92573 3.87398 4.47573 5.34898C3.02573 6.82398 2.25073 8.79898 2.2924 10.899V16.049C2.2924 17.324 3.3674 18.399 4.6424 18.399C5.9174 18.399 6.9924 17.324 6.9924 16.049V13.7073C6.9924 13.1407 6.53407 12.799 6.08407 12.799C5.5174 12.799 2.2924 13.2573 2.2924 13.7073V16.1407C2.2924 16.4823 2.00907 16.7657 1.6674 16.7657C1.32573 16.7657 1.0424 16.4823 1.0424 16.1407V13.7073C1.0424 12.499 4.87573 11.549 6.08407 11.549C7.2924 11.549 8.2424 12.499 8.2424 13.7073V16.049C8.2424 17.999 6.5924 19.649 4.6424 19.649Z" fill="#6B7385"></path>
                                            </svg>
                ...
                <div class="off-menu">
                    ...
                    <div class="mt-3 flex-shrink-0">
                        <ul class="list-unstyled ps-0">
                            ...
                            <li><a class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3" href="{{ route('ebooks') }}">{{ get_phrase('Ebooks') }}</a>
                            </li>
                            ...
                            {{-- <li><a href="{{ route('team.packages') }}" class="btn btn-toggle-list d-inline-flex align-items-center text-16px fw-500 w-100 rounded border-0 py-3">{{ get_phrase('Team Training') }} --}}
                        </ul>
                    </div>
                    @guest
                        <div class="btn-off">
