            ...
            <div class="col-md-12">
                <div class="lms-banner-area-4">
                    <div class="uv-banner-content drop-area">
                        ...
                        <p class="subtitle-5 max-w-620px fs-15px lh-24px text-white text-center mb-30px builder-editable" builder-identity="2">{{ get_phrase('শেখা হোক আনন্দে') }}</p>
                                            ...
                                            <div class="lms-video">
                                                ...
                                                @else
                                                    ...
                                                    <div class="plyr__video-embed universityPlayer" id="player{{ $key }}">
                                                        <iframe src="https://www.youtube.com/embed/{{$youtubeVideoId}}?origin=https://plyr.io&iv_load_policy=3&modestbranding=1&playsinline=1&showinfo=0&rel=0&enablejsapi=1" allowfullscreen allowtransparency allow="autoplay"></iframe>
                                                    </div>
