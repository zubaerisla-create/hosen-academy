        ...
        <div class="row">
            <div class="col-md-12">
                <div class="development-banner-area">
                    ...
                    @endphp
                    <h1 class="title">
                        <span class="builder-editable" builder-identity="1">{{ get_phrase('আপনার শেখার পরিধি বাড়ান, বিশেষজ্ঞ শিক্ষকদের মাধ্যমে।') }}</span>
                        <span class=" font-italic highlight builder-editable" builder-identity="2">{{ get_phrase(' ') }}</span>
                    </h1>
            ...
            <div class="col-md-12">
                <div class="development-hero-area1 d-flex align-items-center justify-content-between drop-area">
                    <div class="hero-rated-profile-area drop-area">
                        ...
                        <p class="info builder-editable" builder-identity="3">{{ get_phrase('15  User already register and signing up for using it') }}</p>
                    </div>
                    <p class="hero-info builder-editable drop-area" builder-identity="4">{{ get_phrase('আপনার শেখার প্রতিটি মুহূর্তকে মূল্যবান করুন।') }}</p>
