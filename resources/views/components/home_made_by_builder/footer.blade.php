        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="footer-content drop-area">
                    ...
                    <p class="description builder-editable" builder-identity="1">{{ get_phrase('নলেজ বেস ও ব্লগে প্রতিদিন পড়ুন ফ্রি টিপস ও গাইডলাইন। ব্যাংকিং, ব্যবসা, গণিত, ইংরেজি ও ক্যারিয়ার বিষয়ক আর্টিকেল পড়ুন। গভীরভাবে শিখতে প্রিমিয়াম কোর্সে থাকছে ভিডিও, PDF ও সাপোর্ট। শেখা হোক বিনিয়োগ, সফলতা হোক সঙ্গী!') }}</p>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer-widget drop-area">
                            ...
                            <div class="newslater-bottom">
                                ...
                                <p class="description builder-editable" builder-identity="3">{{ get_phrase('হোসেন একাডেমি সাবস্ক্রাইব করুন — আপনার শেখার যাত্রা শুরু হোক এখানেই

নতুন স্কিল শিখতে চান? ক্যারিয়ারে এগিয়ে যেতে চান?
তাহলে এখনই হোসেন একাডেমি সাবস্ক্রাইব করুন—
যেখানে পাবেন মানসম্মত কোর্স, বিশেষজ্ঞের গাইডলাইন, এবং একটি সক্রিয় শিক্ষার্থী কমিউনিটির সহযোগিতা।') }}</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="copyright-text">
                        <p class="builder-editable" builder-identity="4">{{ get_phrase('© 2026 All Rights Reserved') }}</p>
                    </div>
                </div>
            </div>
        </div>
