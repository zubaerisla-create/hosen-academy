    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="section-title drop-area">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="user-slider owl-carousel owl-theme">
                    ...
                    <div class="single-opinion">
                        ...
                        <div class="testimonial-border">
                            <div class="testimonial-des">
                                <span class="description overlay-content overlay-content-max-h-150"><span class="builder-editable" builder-identity="15">{{ get_phrase('Write your testimonial content here') }}</span></p>
                                    <div class="user-info d-flex">
                                        <div class="ellipsis-line-2">
