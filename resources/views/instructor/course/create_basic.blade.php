...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-control ol-form-control select2" name="category_id" id="category_id" required>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-control ol-form-control select2" name="level" id="level" required>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <select class="form-control ol-form-control select2" name="language" id="language" required>
...
<div class="row mb-3 ">
    ...
    <div class="col-sm-10">
        <div class="eRadios">
            ...
            <div class="form-check">
                <input type="radio" value="deactive" name="status" class="form-check-input eRadioDark" id="status_deactive" required>
