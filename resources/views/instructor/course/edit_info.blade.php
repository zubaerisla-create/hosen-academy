            ...
            @if (is_array($faqs) && count($faqs) > 0)
                @foreach ($faqs as $key => $faq)
                    <div class="d-flex mt-2">
                        ...
                        <div class="">
                            @if ($key == 0)
                                <button type="button" class="btn ol-btn-light ol-icon-btn" name="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Add new') }}" onclick="appendFaq()"> <i class="fi-rr-plus-small"></i> </button>
                            @else
                                <button type="button" class="btn ol-btn-light ol-icon-btn mt-0" name="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Remove') }}" onclick="removeFaq(this)"> <i class="fi-rr-minus-small"></i> </button>
                            @endif
                        </div>
                    </div>
                @endforeach
            ...
            @if (is_array($requirements) && count($requirements) > 0)
                @foreach ($requirements as $key => $requirement)
                    <div class="d-flex mt-2">
                        ...
                        <div class="">
                            @if ($key == 0)
                                <button type="button" class="btn ol-btn-light ol-icon-btn" name="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Add new') }}" onclick="appendRequirement()"> <i class="fi-rr-plus-small"></i> </button>
                            @else
                                <button type="button" class="btn ol-btn-light ol-icon-btn mt-0" name="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Remove') }}" onclick="removeRequirement(this)"> <i class="fi-rr-minus-small"></i> </button>
                            @endif
                        </div>
                    </div>
                @endforeach
            ...
            @if (is_array($outcomes) && count($outcomes) > 0)
                @foreach ($outcomes as $key => $outcome)
                    <div class="d-flex mt-2">
                        ...
                        <div class="">
                            @if ($key == 0)
                                <button type="button" class="btn ol-btn-light ol-icon-btn" name="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Add new') }}" onclick="appendOutcome()"> <i class="fi-rr-plus-small"></i> </button>
                            @else
                                <button type="button" class="btn ol-btn-light ol-icon-btn mt-0" name="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Remove') }}" onclick="removeOutcome(this)"> <i class="fi-rr-minus-small"></i> </button>
                            @endif
                        </div>
                    </div>
                @endforeach
