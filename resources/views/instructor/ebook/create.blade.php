...
@push('title', get_phrase('Create book'))
        ...
        <div class="col-lg-12">
            ...
            <div class="ol-card p-3">
                <div class="ol-card-body">
                    <form action="{{ route('instructor.ebook.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="eForm-layouts">
                                            ...
                                            <div class="paid-section" id="paid-section">
                                                <div class="fpb-7 mb-3">
                                                    ...
                                                    <input type="number" name="price"
                                                        ...
                                                        min="1" step=".01"
                                                        placeholder="{{ get_phrase('Enter your ebook price') }} ({{ currency() }})">
                                                </div>
                                    ...
                                    <div class="fpb-7 mb-3">
                                        ...
                                        <input type="date" name = "published_date"
                                            ...
                                            placeholder="{{ get_phrase('Enter Published Date') }}" required>
                                    </div>
                                </div>
                                <div class="fpb-7 mb-3">
                                ...
                                <div class="fpb-7 mb-3">
                                    <label for="preview"
                                        class="form-label ol-form-label">{{ get_phrase('Ebook preview file') }}
                                        <span class="text-danger ms-1">*</span></label>
                                ...
                                <div class="fpb-7 mb-3">
                                    <label for="complete"
                                        class="form-label ol-form-label">{{ get_phrase('Ebook complete file') }}
                                        <span class="text-danger ms-1">*</span></label>
