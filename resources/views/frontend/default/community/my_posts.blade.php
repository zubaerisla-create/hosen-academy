...
@push('title', get_phrase('My Posts'))
@push('meta')@endpush
@push('css')@endpush
@section('content')
    @php
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if ($auth && $post->user_id == $auth->id)
                                                    <li><a class="dropdown-item" href="javascript:void(0);" onclick="confirmModal('{{ route('post.delete', $post->id) }}')">{{ get_phrase('Delete') }}</a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
