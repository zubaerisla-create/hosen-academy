            ...
            <div class="course-video-wrap">
                <div class=" bd-r-10 mb-16 position-relative bg-light custom-system-video">
                    <video id="player" playsinline controls oncontextmenu="return false;">
                        ...
                        @if(file_exists('public/uploads/lesson_file/videos/'.$lesson_details->id.'.vtt'))
                            <track label="Caption" kind="subtitles" srclang="cp" src="{{asset('uploads/lesson_file/videos/'.$lesson_details->id.'.vtt')}}" default />
                        @endif
                    </video>
                    @include('course_player.player_config')
                </div>
    ...
    @elseif($lesson_details->lesson_type == 'document_type')
        ...
        @elseif($lesson_details->attachment_type == 'doc' || $lesson_details->attachment_type == 'ppt')
            ...
            <iframe class="embed-responsive-item" width='100%' height="600px"
                src="https://view.officeapps.live.com/op/embed.aspx?src={{ urlencode(asset('uploads/lesson_file/attachment/'.$lesson_details->attachment)) }}"
                frameborder='0'>
