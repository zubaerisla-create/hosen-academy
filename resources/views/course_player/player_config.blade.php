...
<div class="overlay" id="nextVideoOverlay">
    ...
    <div class="cancel-icon" id="cancelNextVideo"><i class="fa-solid fa-xmark"></i></div>
</div>
...
<script type="text/javascript">
    ...
    player.on('timeupdate', event => {
            ...
            // Check if it's a multiple of 5 and hasn't triggered yet
            if (lesson_id && course_id && currentSecond > 0 && currentSecond % 5 === 0 && currentSecond !== previousSavedDuration) {
                previousSavedDuration = currentSecond;
                ...
                $.ajax({
                    ...
                    data: {
                        lesson_id: lesson_id,
                        course_id: course_id,
                        current_duration: currentSecond,
                    },
                    headers: {
